  ...
  <div>
    <panel class="container">
      ...
      <div class="content markdown-body">
        <ul>
          <li v-for="lang in languages" :key="lang">{{lang.name}} ( {{lang.description}} )
    ...
    <panel :padding="15" class="container">
      ...
      <div class="content">
        <ul>
          ...
          <li><b>Time Limit Exceeded</b>  :	The CPU time your program used has exceeded limit. Java has a triple time limit. </li>
          <li><b>Memory Limit Exceeded</b> :	The memory your program actually used has exceeded limit.</li>
          <li><b>System Error</b> :	Oops, something has gone wrong with the judger. Please report this to administrator.</li>
        </ul>
      </div>
    </panel>
